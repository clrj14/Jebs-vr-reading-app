...
This project cotnains a tempplate for Jebs Reading Game sprint.
...
```
Unity Version 2019.3.3f1 (Download through Unity Hub)
Oculus Rift S or Quest if you plan to implement hand tracking. 
```
